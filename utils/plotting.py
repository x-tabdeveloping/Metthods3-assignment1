...
def plot_prior_posterior_update(trace: az.InferenceData) -> None:
    ...
    for var in variables:
        ...
        px.histogram(
            ...
            barmode="overlay",
            height=400,
        ).update_yaxes(matches=None).update_xaxes(matches=None).show()


def plot_posterior_group_comparison(trace: az.InferenceData) -> None:
